...
|---|---|---|
| Copy SMART/badblocks logs from TrueNAS to Windows | Move test result files from NAS to Windows without root SSH login | [Open SOP](/sop/truenas/copy-test-results-to-windows/) |
| Run SMART short and long tests | Check drive health before and after burn-in | [Open SOP](/sop/truenas/smart-tests/) |
| Run badblocks on new HDDs | Stress-test new/refurbished HDDs before trusting them | [Open SOP](/sop/truenas/badblocks/) |
| Identify drives by serial number | Match `/dev/sdX` to real physical drives and serial numbers | [Open SOP](/sop/truenas/identify-drives-by-serial/) |
| Move root-owned files to admin-accessible folder | Fix permission issues when copying files off TrueNAS | [Open SOP](/sop/truenas/move-root-owned-files/) |
| Drive replacement / RMA checklist | Avoid sending back the wrong drive | [Open SOP](/sop/truenas/drive-rma-checklist/) |
